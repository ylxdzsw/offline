(function (root) {
    ...
    const messages = {
        en: {
            ...
            spiderGesture: 'Tap a card and its destination, or drag with a mouse. Only same-suit descending runs move together.',
        ...
        zh: {
            ...
            spiderGesture: '点选纸牌后再点目标牌列；鼠标也可拖动。只有同花色连续降序牌组能整体移动。',
