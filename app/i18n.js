(function (root) {
    ...
    const messages = {
        en: {
            ...
            aiUnavailable: 'The opponent could not finish this turn. Retry or undo your move.',
            retry: 'Retry',
            youWin: 'You win',
            ...
            junqiBattleAttacker: 'The attacking piece survived — your turn',
            junqiBattleDefender: 'The defending piece survived — your turn',
            ...
            game2048Controls: 'Swipe or use the arrow keys',
            ...
            huarongHintUnavailable: 'Hint unavailable. Try again.',
            ...
            slidingControls: 'Tap or drag a tile. Arrow keys move the empty space.',
        ...
        zh: {
            ...
            yourTurn: '请走棋',
            aiThinking: '对手思考中…',
            aiUnavailable: '对手未能完成本回合。请重试或悔棋。',
            retry: '重试',
            youWin: '你赢了',
            aiWins: '对手获胜',
            draw: '和棋',
            ...
            junqiBattleAttacker: '进攻方幸存——请走棋',
            junqiBattleDefender: '防守方幸存——请走棋',
            ...
            huarongHintUnavailable: '提示暂不可用，请重试。',
            ...
            slidingControls: '点击或拖动方块；方向键移动空格。',
                ...
                sections: [
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            'Use arrow keys to select a cell, 1–9 or the number pad to enter, Shift+1–9 for notes, and Backspace/Delete to erase. Changing difficulty asks before discarding a puzzle in progress.',
                        ],
                    },
                ],
            },
                ...
                sections: [
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            'Choose Fill or Cross, then tap a cell to toggle that mark. Right-click to cross a cell, or use arrow keys to move, F to fill, and X to cross.',
                            'Tap a marked cell again to clear it. Puzzle, difficulty, marks, and elapsed time save locally and remain available offline. Changing difficulty asks before discarding your progress.',
                        ],
                    },
                ],
            },
                ...
                sections: [
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            'Tap or click a source card and then its destination. You may also drag cards; double-click a waste or tableau card to try its foundation. Arrow keys navigate cards, Enter selects, and Escape cancels a selection.',
                ...
                sections: [
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            'Tap or click a source card and then a destination column. You may also drag a valid same-suit run. Arrow keys navigate cards, Enter selects, and Escape cancels a selection.',
                ...
                sections: [
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            '“悔棋”可撤销最近一次填数或笔记变化。',
                            '使用方向键选择格子，1–9 或数字小键盘填数，Shift+1–9 记笔记，Backspace/Delete 清除。更改难度时会先确认是否放弃当前进度。',
                        ],
                    },
                ],
            },
                ...
                sections: [
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            '选择“涂黑”或“排除”后点击一格即可切换标记；右键可画叉，也可用方向键移动、F 涂黑、X 画叉。',
                            '再次点击已标记的格子可清除标记；题目、难度、标记和用时都会保存在本机，可离线继续。更改难度前会先确认是否放弃进度。',
                        ],
                    },
                ],
            },
                ...
                sections: [
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            '点选来源纸牌，再点击目标位置，也可拖动。双击废牌或牌列中的纸牌，会尝试送入收牌区。方向键移动焦点，Enter 选择，Escape 取消选择。',
                ...
                sections: [
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            '先点选来源纸牌，再点击目标牌列，也可拖动合法的同花色牌组。方向键移动焦点，Enter 选择，Escape 取消选择。',
